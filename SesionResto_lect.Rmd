...
subtitle: "Bloque Estadística Descriptiva e Inferencial.<br> Notas sobre R y RStudio. Sesión 2"
...
Este documento recoge lo explicado sobre R y RStudio en la primera sesión. No aborda aspectos como la instalación de R y RStudio, aspectos bien cubiertos en muchos otros recursos, algunos mencionados en la bibliografía.
...
### Tidyverse.
### Paquetes gt y gtsummary
### Gráficos con ggplot2.
## Inferencia con medias.  ANOVA (una vía).
## Correlación y regresión lineal simple.
## Inferencia con proporciones. Regresión logística binaria simple.
